...
printSlow(f"Hi,{name},nice name by the way,are you ready to show off your skill?\n")
...
while restart == 0 and life > 0 and turns < 5 and monster_energy > 0:
    ...
    printSlow("There are two types of weapons for you to choose: \nKnife = 0 \nLaser missle = 1\n" )
    ...
    if weapon_choice == 0:
        ...
        printSlow("You are at the entrance and beginning to move forward >>>\n")
...
#Joe + Ethan + Max + Ashkan
        ...
        if pick_direction == 0:
            printSlow( "Luckily, you arrive at a Recovery Centre, Engery level +50. \n1:You can try to go right next time. \n")
            ...
            while True:
              ...
              if player_kill == "k":
                ...
                if monster_energy <= 0 and player_energy >= 0:
                    print("You defeat the monster! congratulation!\n\033[1;31;48mGame is over!!!")
...
#Ethan              
                    ...
                    if life > 0:
                      ...
                      restart = int(input("Press 0 to restart:\n"))
                       ...
                       print("Unfortunately, you have already taken three lifes\n\033[1;31;48mGame is over!!! \n")
...
#Joe        
      while turns < 5:
        ...
        if player_run == "r":
           ...
           run_direction = int(input("Which direction do you want to go?\n"))
           ...
           if run_direction == monster_catch_possiblities:
              ...
              printSlow("Um... The monster chooses the same direction with you \nYou are dead!!!")
              print("")
...
#Ethan
              ...
              if life > 0:
                ...
                print(" ")
                printSlow(f"Fortunately, you have {life} life remaining! ")
                print("")

                restart = int(input("press 0 to restart:\n"))
                
              elif life == 0:
                printSlow("Unfortunately, you have already taken three lifes\n\033[1;31;48mGame is over, try more times!!!")
...
#Joe          
               ...
               print("Continue to run.The monster haven't caught you yet!!!")
               ...
               if turns == 5:
                 ...
                 print(" ")
                 printSlow("\033[1;31;48mjYou have successfully passed the maze. Congradulation!!!\n")
